...
for ARCH in arm64 x86_64; do
    ...
    BINARIES+=("$BIN/VolumeControl")
    HELPERS+=("$BIN/DuckMeter")
done
...
# Measures macOS's call ducking; see Sources/DuckMeter.
lipo -create -output "$APP/Contents/MacOS/DuckMeter" "${HELPERS[@]}"
...
codesign --force --sign - "$APP/Contents/MacOS/DuckMeter"
